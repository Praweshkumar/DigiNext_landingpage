...
// function updateActiveTab() {
  ...
  if (!element) {
    console.warn("Section not found:", element);
    return 0; // fallback so your code doesn't break
  }
...
const sections = [
  { id: "aeps", element: aepsSection, offset: getOffset(aepsSection) },
  { id: "bbps", element: bbpsSection, offset: getOffset(bbpsSection) },
  { id: "dmt", element: dmtSection, offset: getOffset(dmtSection) },
  { id: "travel", element: travelSection, offset: getOffset(travelSection) },
  { id: "insurance", element: insuranceSection, offset: getOffset(insuranceSection) },
  { id: "loan", element: loanSection, offset: getOffset(loanSection) },
];
...
//   function updateActiveTab() {
//   const scrollPosition = window.scrollY + 110; // adjust for header

//   const sections = [
//     { id: "aeps", element: document.getElementById("aeps") },
//     { id: "bbps", element: document.getElementById("bbps") },
//     { id: "dmt", element: document.getElementById("dmt") },
//     { id: "travel", element: document.getElementById("travel") },
//     { id: "insurance", element: document.getElementById("insurance") },
//     { id: "loan", element: document.getElementById("loan") },
//   ];
